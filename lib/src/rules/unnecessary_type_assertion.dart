...
// Inspired by TSLint (https://palantir.github.io/tslint/rules/no-unnecessary-type-assertion/)

class UnnecessaryTypeAssertionRule extends BaseRule {
  static const String ruleId = 'unnecessary-type-assertion';
  static const _documentationUrl = 'https://git.io/JU6GW';

  static const _failure = 'Missing blank line before return';

  UnnecessaryTypeAssertionRule({Map<String, Object> config = const {}})
      : super(
            id: ruleId,
...
class _Visitor extends RecursiveAstVisitor<Object> {
  ...
  void visitMethodInvocation(MethodInvocation node) {
    ...
    if (node.methodName.name != 'whereType') {
      return;
    }

    final target = node.realTarget;
    if (target == null ||
        !implementsInterface(target.staticType, 'Iterable', 'dart.core')) {
      return;
    }
